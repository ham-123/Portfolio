...
<head>
  ...
  <title>AdminLTE 3 | {!! !empty('$meta_title') ? $meta_title:''!!}</title>
...
<script src="{{ url('backend/backend/plugins/jqvmap/maps/jquery.vmap.usa.js')}}"></script>
<!-- jQuery Knob Chart -->
<script src="{{ url('backend/backend/plugins/jquery-knob/jquery.knob.min.js')}}"></script>
<!-- daterangepicker -->
