...
<header class="header" id="navbar-collapse-toggle">
    ...
    <ul class="icon-menu d-none d-lg-block revealator-slideup revealator-once revealator-delay1">
        <li class="icon-box @if(Request::segment(1) == 'home') active @endif">
    ...
    <nav role="navigation" class="d-block d-lg-none">
        <div id="menuToggle"> 
            ...
            <ul class="list-unstyled" id="menu">
                <li class="icon-box @if(Request::segment(1) == 'home') active @endif"> <a href="{{ route('index') }}"><i class="fa fa-home"></i><span>Accueil</span></a></li>
                <li class="icon-box @if(Request::segment(1) == 'about') active @endif"> <a href="{{ route('about') }}"><i class="fa fa-user"></i><span>About</span></a></li>
                <li class="icon-box @if(Request::segment(1) == 'portfolio') active @endif"><a href="{{ route('portfolio') }}"><i class="fa fa-folder-open"></i><span>Portfolio</span></a></li>
                <li class="icon-box @if(Request::segment(1) == 'contact') active @endif"><a href="{{ route('contact') }}"><i class="fa fa-envelope-open"></i><span>Contact</span></a></li>
                <li class="icon-box @if(Request::segment(1) == 'blog') active @endif"><a href="{{ route('blog') }}"><i class="fa fa-comments"></i><span>Blog</span></a></li>
            </ul>
        </div>
    </nav>
    <!-- Mobile Menu Ends -->
